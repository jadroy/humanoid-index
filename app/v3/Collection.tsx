...
function Card({ item, trueToSize, refSize, centered, selected, onOpen, openHint, hint }: { item: CollectionItem; trueToSize: boolean; refSize: number; centered: boolean; selected?: boolean; onOpen?: () => void; openHint?: string; hint?: boolean }) {
